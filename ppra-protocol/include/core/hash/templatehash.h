...
/**
 * @brief The function generate the template hash based on sha256 algorithm.
 * 
 * @param ev [in] event struct with file name, file path and file hash
 * @param digest [out] digest of the template hash
 * @return int 
 */
